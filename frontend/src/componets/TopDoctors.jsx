...
import { AppContext } from "../context/AppContext"; // Make sure this matches the exported name

const TopDoctors = () => {
  const navigate = useNavigate();
  const { doctors } = useContext(AppContext); // Correct context name
        ...
        {doctors.slice(0, 10).map((item, index) => (
          <div
            onClick={() => {
              ...
              scrollTo(0, 0);
            }} // Fixed typo: `appointement` -> `appointment`
            key={index}
